...
public abstract class BaseViewModel extends ViewModel {
    ...
    public final LiveData<ProvisionedMeshNode> setMeshModel(){
        return  mNrfMeshRepository.getSelectedMeshNode();
    }
    ...
    public void setVendorModel( MeshModel meshModel){
        meshModel = getSelectedModel().getValue();
        mNrfMeshRepository.setSelectedModel(meshModel);
    }
...
//        String s = getSelectedMeshNode().getValue();
//        return  s;
//    }
}
